...
/**
 * Контракт игровых артефактов, реализованный в виде ERC-721 токена
 */
...
contract ImpItem is ERC721Token, Ownable {
    ...
    /*
    * Возвращает базовый URI для всех токенов
    */
    function symbol() external view returns (string) {
        return symbol_;
    }
    ...
    /*
    * Владелец токена может его сжечь
    */
    ...
    /*
    * Получение нового токена для данных, которые подписал сервер
    */
    function mint(uint _tokenId, string _uri, bytes _signedData) external {
        ...
        // Если такой токен уже был выдан, то _mint не вызовется
